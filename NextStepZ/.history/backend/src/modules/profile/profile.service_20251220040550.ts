...
export class ProfileService {
  ...
  async createProfile(userId: string, createProfileDto?: CreateProfileDto) {
    ...
    const profile = await this.prisma.profile.create({
      data: {
        userId,
        firstName: (createProfileDto?.firstName || user.firstName) as string | null,
        lastName: (createProfileDto?.lastName || user.lastName) as string | null,
        email: user.email as string | null,
        phone: user.phone as string | null,
        avatar: user.avatar as string | null,
        province: (createProfileDto?.province || user.province) as string | null,
  ...
  async updateProfile(userId: string, updateProfileDto: UpdateProfileDto) {
    ...
    const updatedProfile = await this.prisma.profile.update({
      where: { userId },
      data: {
        firstName: (updateProfileDto.firstName || profile.firstName) as string | null,
        lastName: (updateProfileDto.lastName || profile.lastName) as string | null,
        ...
        province: (updateProfileDto.province || profile.province) as string | null,
