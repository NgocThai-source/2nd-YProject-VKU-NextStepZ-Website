          ...
          >
            ...
            <div className="space-y-2">
              <Input
                ...
                className="bg-slate-800/50 border-slate-600 text-white focus:border-cyan-400 focus:ring-cyan-400 text-sm md:text-base"
              />
              {formData.birthDate && (
                <p className="text-xs text-gray-400" style={{ fontFamily: "'Poppins Regular', sans-serif" }}>
                  Ngày sinh: <span className="text-cyan-400">{formatDate(formData.birthDate)}</span>
                </p>
              )}
            </div>
          </motion.div>
