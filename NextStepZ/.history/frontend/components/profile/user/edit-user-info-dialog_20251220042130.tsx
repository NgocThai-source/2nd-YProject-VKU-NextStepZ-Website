          ...
          >
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-slate-700/30 border-slate-600 text-gray-400 placeholder-gray-500 cursor-not-allowed text-sm md:text-base"
                style={{ fontFamily: "'Poppins Regular', sans-serif" }}
              />
            ...
            <div className="space-y-2">
              ...
              <Input
                type="text"
                value={data?.birthDate ? formatDate(data.birthDate) : 'Chưa cập nhật'}
                disabled={true}
                className="bg-slate-700/30 border-slate-600 text-gray-400 placeholder-gray-500 cursor-not-allowed text-sm md:text-base"
                style={{ fontFamily: "'Poppins Regular', sans-serif" }}
              />
