      ...
      try {
        ...
        try {
          ...
          if (userRes.ok) {
            ...
            // Auto-create or fetch public profile after user profile is loaded
            try {
              ...
              if (publicRes.ok) {
                ...
                console.error('Failed to create/fetch public profile', {
                  status: publicRes.status,
                  statusText: publicRes.statusText,
                  error: errorText,
                });
              }
            } catch (pubErr) {
              console.error('Error creating public profile:', pubErr);
            }
          }
        } catch (err) {
