              ...
              {!submitted && (
                <div className="border-t border-cyan-400/10 p-6 bg-slate-800/95 flex items-center justify-end gap-3">
                  ...
                  <motion.button
                    ...
                    className="px-6 py-2 rounded-lg bg-linear-to-r from-yellow-500 to-orange-500 text-white font-semibold hover:shadow-lg hover:shadow-orange-500/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    style={{ fontFamily: "'Exo 2 Medium', sans-serif" }}
                  >
