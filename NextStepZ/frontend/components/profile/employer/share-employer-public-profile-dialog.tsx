...
interface ShareEmployerPublicProfileDialogProps {
  isOpen: boolean;
  onClose: () => void;
  employerProfile?: {
    companyName?: string;
        ...
        <div className="space-y-6 py-4">
          ...
          >
            <p className="text-xs text-cyan-300" style={{ fontFamily: "'Poppins Regular', sans-serif" }}>
              💡 Mẹo: Chia sẻ hồ sơ công khai của bạn để những ứng viên tiềm năng có thể tìm kiếm và xem thông tin công ty của bạn.
            </p>
          </motion.div>
        </div>
      </DialogContent>
